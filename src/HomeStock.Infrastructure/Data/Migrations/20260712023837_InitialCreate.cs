        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedName = table.Column<string>(type: "TEXT", maxLength: 60, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncludeSublocations = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelNumber = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    SerialNumber = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    Barcode = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    PurchaseDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    PurchaseLocation = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ...
                    WarrantyExpiration = table.Column<DateOnly>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovedToLocationId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuditItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuditItems_Locations_MovedToLocationId",
                        column: x => x.MovedToLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItemId = table.Column<int>(type: "INTEGER", nullable: false),
                    BorrowerName = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    BorrowerContact = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    LoanDate = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    ExpectedReturnDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditItems_ItemId",
                table: "AuditItems",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditItems_MovedToLocationId",
                table: "AuditItems",
                column: "MovedToLocationId");
